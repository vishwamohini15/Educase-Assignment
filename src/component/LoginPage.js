...
export const LoginPage = ({ setScreen }) => {
  ...
  return (
   <div className="h-full flex flex-col p-6 md:p-4">
            ...
            <p className="text-gray-500 mb-8 md:mb-3">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
            </p>
            <div className="space-y-3">
                <div>
                    <label htmlFor="email" className="text-sm font-semibold text-blue-700">Email Address</label>
                    <input
                        type="email"
                        id="email"
                        placeholder="Enter email address"
                        className="mt-1 w-full p-3 rounded-lg border border-gray-300 focus:border-purple-500 focus:ring focus:ring-purple-200 focus:outline-none"
                    />
                </div>
                <div>
